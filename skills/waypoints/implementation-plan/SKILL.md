...
1. Read repository instructions, the task or spec, relevant code, and existing plan conventions.
...
3. Preserve the spec's scope; surface contradictions rather than adding requirements.
