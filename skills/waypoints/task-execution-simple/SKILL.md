...
description: Implement or finish a supplied engineering task with adaptive isolation, verification, documentation updates, and durable Git checkpoints. Use when scoped work is ready to change, review, verify, or commit without requiring Waypoint's optional docs convention or a fixed task structure.
---
